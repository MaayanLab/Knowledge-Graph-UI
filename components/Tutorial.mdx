...
3. 3 - [Searching the KG](#grn-search)
	1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1 - Single term search
    2. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2 - Expanded single term search
	3. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3 - Two term search
4. 4 - [Interacting with the subnetwork using the toolbar](#interact-network)
    1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1 - Adjust network view
    2. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2 - Downloading the network
5. 5 - [Enrichment analysis with ChEA-KG](#chea-enrichment)
	1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1 - Performing a query
	2. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2 - Filtering the results
	3. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3 - Viewing results in a table or bar chart
...
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tutorial_enrichment/example_results1.png" alt="drawing" width="700" style="border: 1px solid grey;" />   
...
**Example**  
Adjust "Add/remove nodes" to 15 and click the send icon ("Submit changes"). The subnetwork will display the top 25 TFs for the same input gene set (Fig. 17).  
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tutorial_enrichment/adding_nodes1.png" alt="drawing" width="500" style="border: 1px solid grey;" />  
**Fig. 17A.** Changing the “Add TFs” to 15 can be used to increase the subnetwork size.  
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tutorial_enrichment/added_nodes1.png" alt="drawing" width="500" style="border: 1px solid grey;" />  
...
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tutorial_enrichment/filtering_z1.png" alt="drawing" width="500" style="border: 1px solid grey;" />   
**Fig. 18A.** Filtering out edges with a Z score of less than 10 by adjusting the edges slider.    
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tutorial_enrichment/z-filtered1.png" alt="drawing" width="500" style="border: 1px solid grey;" />    
...
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tutorial_enrichment/table_view1.png" alt="drawing" width="700" style="border: 1px solid grey;" />  
**Fig. 19.** View the ChEA-KG enrichment analysis results as a table. 

<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tutorial_enrichment/bar_view_tooltip1.png" alt="drawing" width="600" style="border: 1px solid grey;" />  
