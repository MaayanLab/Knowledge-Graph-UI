...
### Table of Contents
1. 1 - [The ChEA-KG GRN](#introduction)
    1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1 - [Searching the KG](#grn-search)
		1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1 - [Single Term Search](#single-search)
        2. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2 - [Subnetwork Search](#subgraph-search)
		3. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3 - [Two Term Search](#two-term-search)
    1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2-[Interacting with the network](#interact-network)
        1. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1 - [Adjust network view](#adjust-vew)
        2. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2 - [Download network](#download)
2. 2 - [Enrichment analysis with ChEA-KG](#chea-enrichment)
...
Edges in the GRN indicate regulatory relationships between source and target TFs, inferred from enrichment analysis. There are two edge types (Figure 1):   
...
**Figure 1.** Subnetwork produced by a single-term search for LYL1.  
...
**Figure 2.** An expanded LYL1 subnetwork is produced by toggling "End node".   
...
**Figure 3.** Subnetwork produced by a two-term search for LYL1 and CHCHDC3.  
...
**Figure 4.** Adjusting the slider changes the number of relationships displayed subnetwork.  
...
**Figure 5.** Enabling the tooltip displays the node ID, label, and URI for each node that is clicked or hovered over.  
...
**Figure 6.** Expand the CTCFL node by clicking expand (top). This displays additional relationships involving the CTCFL node (bottom). 

<p>&nbsp;</p>

*Delete the expanded CTCFL node by clicking delete:*  
...
**Figure 7.** Remove the CTCFL node by clicking delete (top). This removes the CTCFL node and its relationships (bottom).  
...
**Figure 9.** Switch to a hierarchical layout using the graph layout button. 
...
**Figure 10.** Display the edge labels using the edge labels button.  
...
**Figure 9.** Show and adjust the size of the legend. 
...
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/enrichment_home1.png" alt="drawing" width="600"/> 
...
**Figure 12.** Enrichment analysis produces a subnetwork of enriched TFs for a gene set. 
