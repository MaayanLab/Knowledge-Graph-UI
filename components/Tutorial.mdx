...
**Figure 5.** Adjusting the slider changes the number of relationships displayed subnetwork.  
...
**Figure 6.** Enabling the tooltip displays the node ID, label, and URI for each node that is clicked or hovered over.  
...
**Figure 7.** Expand the CTCFL node by clicking expand (top). This displays additional relationships involving the CTCFL node (bottom). 
...
**Figure 9.** Expand the CTCFL node by clicking expand (top). This displays additional relationships involving the CTCFL node (bottom).  
