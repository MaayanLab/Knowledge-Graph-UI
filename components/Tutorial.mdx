...
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/search-home.png" alt="drawing" width="200"/> 
...
<img src="https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/introduction.png" alt="drawing" width="200"/> 
...
![single-term](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/single-term.png)  
...
![subgraph](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/subgraph.png)    
...
![two-term](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/two-term.png)  
...
![size](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/network_size.png)  
**Full-screen:**  
...
![tooltip](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/tooltip.png)  
**Deletee or expand a node:**  
With the tooltip enabled, hover over the node of interest and click on the delete or expand buttons. 
![expand](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/expand1.png) ![remove](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/delete1.png)  
   
After expand:  
![expanded](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/expand2.png)
  
After delete:  
![removed](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/delete2.png)   
  
**Network and table view:**  
Toggle between network and table view by clicking on their respective buttons
![table-view](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/table_view.png)  
**Switch graph layout:**  
Switch between force-directed, geometric, or hierarchical graph layouts. 
![hierarchical](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/heirarchical-layout.png)  
**Show edge labels:**  
Display the edge labels ("upregulates", "downregulates") over the edges
![edge-labels](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/edge-label.png)  
**Show legend:**  
Show the legend. An additional toolbar button is displayed that adjusts the size of the legend when clicked.  
![legend](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/legend.png)  
...
![nodes-and-edges](https://minio.dev.maayanlab.cloud/hgrn-chear/tutorial/enrichment_home.png) 
