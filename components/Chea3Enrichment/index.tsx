            ...
            <Grid container spacing={1} alignItems={"flex-start"}>
                <Grid item xs={12}>
                    ...
                    { props.disableHeader ? <Typography variant={"subtitle1"}>Enter a set of Entrez gene symbols below to perform transcription factor enrichment analysis using&nbsp;
                            ...
                            </Link>. The result is a subnetwork of the ChEA-KG GRN, made of the top {add_nodes ? 10 + add_nodes : 10} mean-ranked transcription factors enriched for the query set.</Typography>:
